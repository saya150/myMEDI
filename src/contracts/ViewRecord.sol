...
contract ViewRecord is ERC721,ReentrancyGuard,AccessControl {
  ...
  // itemId -> Item
    ...
    constructor() ERC721("MyMEDI", "MTKN") {
     ...
     function makeItem(IERC721 _nft, uint _tokenId,string memory _description,string memory  _recordName) external nonReentrant {
